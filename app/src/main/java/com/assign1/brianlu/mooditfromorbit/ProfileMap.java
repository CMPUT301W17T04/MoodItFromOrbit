...
public class ProfileMap extends CustomAppCompatActivity implements MView<MainModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Profile Map");
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_dashboard:
                        Intent intent = new Intent(ProfileMap.this,DashBoard.class);
                        startActivity(intent);
                        return true;

                    case R.id.action_profile:
                        // temporary because the main following function is not implemented
                        Intent intent2 = new Intent(ProfileMap.this, ProfileActivity.class);
                        startActivity(intent2);
                        return true;

                    case R.id.action_all:
                        // temporary because the main following function is not implemented
                        Intent intent3 = new Intent(ProfileMap.this, FollowSomeoneActivity.class);
                        startActivity(intent3);
                        return true;

                    case R.id.action_requests:
                        // temporary because the main following function is not implemented
                        Intent intent4 = new Intent(ProfileMap.this, AcceptFollowerActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add_mood:
                ...
                Intent intent1 = new Intent(ProfileMap.this, AddMood.class);
            ...
            case R.id.action_logout:
                Intent intent5 = new Intent(ProfileMap.this, MoodMainActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.profile_menu_map, menu);
...
//            theAddress +=  addresses.get(0).getFeatureName();
    ...
    private void getSelfMoods(){
        MainController mc = MainApplication.getMainController();
        moods = mc.getMe().getMoods();
    }
